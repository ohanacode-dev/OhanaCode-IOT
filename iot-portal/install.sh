...
sudo apt install -y python3-pip mosquitto mosquitto-clients python3-dev python3-smbus i2c-tools python3-libgpiod libfreetype6-dev fonts-font-awesome fonts-dejavu libjpeg-dev
sudo pip3 install paho-mqtt fastapi uvicorn jinja2 aiofiles websocket-client websockets fontawesome OrangePi.GPIO pillow luma.oled
